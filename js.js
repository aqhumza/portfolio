...
const list=document.querySelector("#sec-b #uclass"); // first we grab the ul element
...
search.addEventListener('submit',function(e)
{
	...
	title.classList.add("rname");    // giving a new class to new elemeent
...
const get=document.forms['search'].querySelector("input"); // grabibng the input of search form
